...
export const jsBoostRequest = (() => {
    ...
    function getName() {
        ...
        $('#txtNome').keyup(function(e){
            if(e.keyCode == 13) {
                ...
                $.getJSON('sys/query_simulator.php?param1='+search, function(data){
                    $("#txtNome").val('');
    ...
    function getData() {
        ...
        $("#btConsulta").click(function(){
            ...
            $.getJSON('sys/query_simulator.php?param1='+$id+'&param2='+$nm, function(data){
                let $random = [];
                let $_id    = null;
